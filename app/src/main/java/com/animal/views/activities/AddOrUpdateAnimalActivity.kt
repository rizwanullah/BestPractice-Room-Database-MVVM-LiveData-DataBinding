...
class AddOrUpdateAnimalActivity : BaseActivity(), View.OnClickListener {
    ...
    private fun initializeViewModel() {
        viewModel = ViewModelProviders.of(this, mainActivityFactory)[MainActivityViewModel::class.java]
    }
...
//            binding.fabChoosePic.visibility = View.GONE
    ...
    private fun validation() {
        when {
            ...
            binding.ageET.text.toString().isEmpty() -> {
                binding.ageET.error = getString(R.string.please_enter_the_age)
            }
            binding.breedET.text.toString().isEmpty() -> {
